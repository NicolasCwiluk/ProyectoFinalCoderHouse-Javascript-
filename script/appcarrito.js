...
const contenedorPrimarioCarrito = document.getElementById(
  "contenedor-primario"
);
...
function agregarAlCarrito(id) {
  ...
  if (burgerEnCarrito) {
    ...
    const producto = {
      id: id,
      nombre: document.getElementById("burgernombre" + id).innerText,
      img: document.getElementById("burgerimg" + id).getAttribute("src"),
      precio: document.getElementById("burgerprecio" + id).innerText,
    };
    producto.cantidad = 1;
